...
require_once __DIR__ . '/../App/Driver/Application.php';

$app = new App\Driver\Application(
    [
        'base'=>  realpath(__DIR__ . '/../App/Driver'),
        'storage'=> realpath(__DIR__ . '/../App/Driver/storage'),
